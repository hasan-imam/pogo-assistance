...
class GenericSpawnMessageProcessorValleyPoGoIntegrationTest {
    ...
    @ParameterizedTest
    @MethodSource(value = { "ValleyPoGoPerfect100ChannelMessages" })
    void process_ValleyPoGoPerfect100ChannelMessages_ReturnsExpected(final Message message) {
    ...
    private static Stream<Message> ValleyPoGoPerfect100ChannelMessages() {
        return MessageStream.lookbackMessageStream(jda.getTextChannelById(CHANNEL_ID_VALLEY_POGO_PERFECT_100))
